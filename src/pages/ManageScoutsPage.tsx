...
import { SubmissionDetailModal, AdminLockScreen, formatTimestamp, type Submission, type FormTemplate } from "@/components/SubmissionDetailModal";
...
export default function ManageScoutsPage() {
  ...
  if (!isAdminMode) return <AdminLockScreen feature="Manage Scouts" />;
